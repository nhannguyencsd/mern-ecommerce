        ...
        <div className={cx('wrapper')}>
            ...
            <details>
                ...
                <div className={cx('content')}>
                    <p>
                        A new feature is nunc lectus eros, volutpat quis suscipit eu, lacinia et justo. Proin turpis mi,
            ...
            <details>
                ...
                <div className={cx('content')}>
                    <p>
                        We ship to sodales sapien massa, euismod imperdiet tellus rutrum nec. Nullam non mauris at
                        tortor posuere bibendum eget non risus. Vestibulum egestas libero fringilla, pretium eros vitae,
                        fermentum nisi.
                    </p>
                </div>
            </details>
            {/* Return Policy headline */}
            <details>
                <summary>
                    <div className={cx('title')}>
                        <svg
                ...
                <div className={cx('content')}>
                    <p>
                        Our return policy is aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos
